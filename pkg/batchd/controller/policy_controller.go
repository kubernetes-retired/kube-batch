...
func NewPolicyController(config *rest.Config, policyName string, schedulerName string, groupLabel string) (*PolicyController, error) {
	...
	policyController := &PolicyController{
		...
		clientset:  cs,
		kubeclient: kc,
		cache:      schedcache.New(config, schedulerName, groupLabel),
		allocator:  alloc,
