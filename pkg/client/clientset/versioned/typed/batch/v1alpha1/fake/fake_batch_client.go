...
import (
	v1alpha1 "github.com/kubernetes-sigs/kube-batch/pkg/client/clientset/versioned/typed/batch/v1alpha1"
...
func (c *FakeBatchV1alpha1) CronJobs(namespace string) v1alpha1.CronJobInterface {
